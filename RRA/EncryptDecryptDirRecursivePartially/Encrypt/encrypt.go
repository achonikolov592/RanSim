...
=======
			helpers.WriteLog(nameOfEncryptionInfoFile, "Where it started to encrypt: "+strconv.Itoa(int(whereToStart)))
			helpers.WriteLog(nameOfEncryptionInfoFile, "How much bytes is product: "+strconv.Itoa(len(encryptedText)))
>>>>>>> 7fc80a6796b63203067b2e2e7540726a00337350
...
=======
			...
			helpers.WriteLog(nameOfLogFile, "Encrypted: "+file)
>>>>>>> 7fc80a6796b63203067b2e2e7540726a00337350
...
=======
	...
	helpers.WriteLog(nameOfEncryptionInfoFile, hex.EncodeToString(key))
